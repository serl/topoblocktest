...
class iperf3m_chain_ns_iptables1000_udp(collection.Collection):
    constants = {
        'iperf_name': 'iperf3m',
        'protocol': 'udp',
    ...
    variables = OrderedDict([
        ...
        ('parallelism', (1, 4, 6, 8)),
        ('iptables_rules_len', (100, 250, 500, 1000)),
    ])

    def generation_skip_fn(self, settings):
        return (settings['chain_len'] - 1) * settings['iptables_rules_len'] != 1000
...
if __name__ == '__main__':
    iperf3m_chain_ns_iptables1000_udp().parse_shell_arguments()
